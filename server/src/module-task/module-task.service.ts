...
export class ModuleTaskService {
    constructor(@InjectModel(ModuleTask.name) private readonly moduleTaskModel: Model<ModuleTaskDocument>) {
    }
    ...
    create(createModuleTaskDto: CreateModuleTaskDto) {
        ...
        return this.moduleTaskModel.create({...createModuleTaskDto, leftWordArr, arrWord})
    }
